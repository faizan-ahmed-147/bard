...
import type {Chain, StepFunction} from "../flow/definition";
import Gateway from "../gateway/gateway";
import Session from "./session";
import type {StorageData} from "./session";
...
export default class Bot<State extends ObjectLiteral = ObjectLiteral> {
